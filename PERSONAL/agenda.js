...
let eventos = JSON.parse(localStorage.getItem("neuropassport_eventos")) || [];
    ...
    for (let dia = 1; dia <= cantidadDias; dia++) {
        ...
        elementoDia.addEventListener(
            ...
            function () {
                ...
                fechaEvento.value = fechaFormateada;
...
guardarEvento.addEventListener(
    ...
    function () {
        ...
        if (tituloEvento.value.trim() === "") {

            alert("Por favor, escribí el nombre del evento.");
